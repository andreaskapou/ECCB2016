...
# -----------------------------------------
k562_file <- "../files/final_cluster_K562_7000_5_4_TueMar221644.RData"
gm_file   <- "../files/final_cluster_GM_7000_5_4_TueMar221634.RData"
h1_file   <- "../files/final_cluster_H1_7000_5_4_TueMar221631.RData"
...
k562_clust_ids <- c(3, 4, 2, 5, 1)

for (i in 1:K){
  k562_labels[[i]] <- which(k562_mix_model$labels == k562_clust_ids[i])
...
mat_clust_ids <- matrix(cbind(k562_clust_ids, gm_clust_ids, h1_clust_ids), ncol = 3)
